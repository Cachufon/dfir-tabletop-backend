#!/usr/bin/env python3
"""
Optionally generate markdown output via OpenAI Responses API.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Optionally generate markdown via OpenAI Responses API.")
    parser.add_argument("--prompt-template", required=True)
    parser.add_argument("--scenario-yaml", default="")
    ...
    print(f"Wrote AI-generated markdown: {out_path}")
    return 0
