#!/usr/bin/env python3
"""Stub executor for IOC sweep detections."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run IOC sweep detections stub")
...
def write_stub_outputs(case_dir: Path, scope_area: str, output_dir: Path) -> None:
    ...
    summary_path.write_text(
        "# IOC sweep detection summary (stub)\n\n"
        "Placeholder summary for IOC sweeps. Populate with real hits and indicators once executed.\n",
        encoding="utf-8",
    )

    print(
        "IOC sweep stub execution completed. No real detections were run. "
